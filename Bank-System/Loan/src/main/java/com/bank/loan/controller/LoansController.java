...
@Tag(
        name = "CRUD REST APIs for Loans in SBI Bank",
        description = "CRUD REST APIs in SBI Bank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside SBI Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
