...
import com.bank.card.services.ICardsService;
...
@Tag(
        name = "CRUD REST APIs for Cards in SBI Bank"
        ,description = "CRUD REST APIs in SBI Bank to CREATE, UPDATE, FETCH AND DELETE card details"
)
@RestController
...
public class CardController {
    ...
    @Operation(
            ...
            description = "REST API to create new Card inside SBI Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
    ...
    public ResponseEntity<ResponseDto> createCard(@Valid
        ...
        this.iCardsService.createCard(mobileNumber);
    ...
    public ResponseEntity<CardDto> fetchCardDetails(@RequestHeader("sbi-bank-correlation-id")
                                                     ...
                                                     String mobileNumber) {
        logger.debug("sbi-bank-correlation-id found: {} ", correlationId);
